...
class Sales(models.Model):
    ...
    def return_amount(self):
        ...
        return_instances = Returns.objects.using('ojota').filter(orderid=self.orderid)
        ...
        for refund_instance in refund_instances:
            ...
            sale_instance = Sales.objects.using('ojota').filter(
    ...
    def process_sale(self, app_label='ojota'):
...
class Returns(models.Model):
    ...
    def process_return(self, app_label='ojota'):
